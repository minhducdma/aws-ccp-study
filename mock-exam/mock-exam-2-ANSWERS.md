...
|---|---|---|---|
| 1 — Cloud Concepts | 4 | 24% | `phase-1-cloud-concepts/01-notes.md` |
| 2 — Security & Compliance | 13 | 30% | `phase-2-security/01-notes.md` |
| 3 — Cloud Technology & Services | 19 | 34% | `phase-3-technology/01-notes.md` |
| 4 — Billing, Pricing & Support | 14 | 12% | `phase-4-billing/01-notes.md` |

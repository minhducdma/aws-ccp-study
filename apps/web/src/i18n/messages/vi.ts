...
export const vi = {
  ...
  'art.studyBuddy': 'Bạn nhỏ đang đọc sách trên bàn học giữa những đám mây',
  'art.mockJourney': 'Lá cờ trên đỉnh núi, tượng trưng cho mục tiêu chinh phục kỳ thi',

  'nav.skip': 'Bỏ qua điều hướng',
  'nav.openMenu': 'Mở menu điều hướng',
  'nav.courseContents': 'Mục lục',
  'nav.courseNavigation': 'Điều hướng khoá học',
  'nav.allCertifications': 'Tất cả chứng chỉ',
  'nav.catalog': 'Chứng chỉ',
  'nav.contents': 'Nội dung',
  'nav.settings': 'Tài khoản và ngôn ngữ',
  ...
  'dashboard.mockIntro': 'Làm trọn đề để rèn nhịp độ và biết mình đã sẵn sàng đến đâu.',
  'dashboard.mockEmpty':
